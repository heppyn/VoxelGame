...
\missingfigure{obrázek klávesnice s voláním metod}
...
Tento kód funguje, pokud jsme ochotni natvrdo zadrátovat vstup hráče k~herním akcím, ale hodně her hráče nechá nakonfigurovat si vlastní mapování tlačítek. K tomuto potřebujeme vyměnit přímé volání metody A za metodu B. K tomu potřebujeme objekt reprezentující volání metody~\cite{gpp_cmd}.
...
\texttt{InputHandler} je odstíněn od volání prováděných na \texttt{actor}, sníží se tak spojení mezi třídami a zvýší se soudržnost (high cohesion) \texttt{InputHandler} – má na starosti zpracování vstupu, ne ovládání herní postavy.

\missingfigure{diagram tříd -- high cohesion}
