...
Chunk ExampleScene::EmptySides([[maybe_unused]] const glm::vec2&) {
...
Chunk ExampleScene::FaceCullingGrass([[maybe_unused]] const glm::vec2&) {
    Chunk chunk(glm::vec2(0.0f));
...
Chunk ExampleScene::AlphaBlendingGrass([[maybe_unused]] const glm::vec2&) {
    Chunk chunk(glm::vec2(0.0f));
...
Chunk ExampleScene::LSystemGrass([[maybe_unused]] const glm::vec2&) {
...
Chunk ExampleScene::LSystemTrees([[maybe_unused]] const glm::vec2&) {
    Chunk chunk(glm::vec2(0.0f));
...
Chunk ExampleScene::PhongLight([[maybe_unused]] const glm::vec2&) {
    Chunk chunk(glm::vec2(0.0f));
...
Chunk ExampleScene::Shadow([[maybe_unused]] const glm::vec2&) {
    Chunk chunk(glm::vec2(0.0f));
...
Chunk ExampleScene::RandomNoiseTerrain([[maybe_unused]] const glm::vec2&) {
    Chunk chunk(glm::vec2(0.0f));
...
Chunk ExampleScene::PerlinSimplexTerrain([[maybe_unused]] const glm::vec2&) {
    Chunk chunk(glm::vec2(0.0f));
...
Chunk ExampleScene::TreeDistribution([[maybe_unused]] const glm::vec2&) {
