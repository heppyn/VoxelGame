 ...
 * @param[in] x float coordinate
 *
 * @return Noise value in the range[0; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::noise0_1(float x) const {
 ...
 * @return Noise value in the range[0; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::noise0_1(float x, float y) const {
 ...
 * @return Noise value in the range[0; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::noise0_1(float x, float y, float z) const {
 ...
 * @return Noise value in the range[0; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::fractal0_1(size_t octaves, float x) const {
    return fractal(octaves, x) * 0.5f + 0.5f;
}
 ...
 * @return Noise value in the range[0; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::fractal0_1(size_t octaves, float x, float y) const {
    return fractal(octaves, x, y) * 0.5f + 0.5f;
}
 ...
 * @return Noise value in the range[0; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::fractal0_1(size_t octaves, float x, float y, float z) const {
    return fractal(octaves, x, y, z) * 0.5f + 0.5f;
}
